...
@WebServlet("/LoadMostSelledProductsServlet")
public class LoadMostSelledProductsServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            ResultSet rs = db.query("SELECT * FROM products ORDER BY selled_num DESC LIMIT 3");
