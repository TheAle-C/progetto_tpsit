...
<html lang="it">
    ...
    <section class="products-section">
            <h2 class="section-title">Centro Garanzia</h2>
            <div class="product-card">
                <div class="contact-info">
                    <p><i class="fas fa-map-marker-alt"></i> Via delle Garanzie 15, Milano</p>
                    <p><i class="fas fa-phone"></i> +39 02 9876543</p>
                    <p><i class="fas fa-clock "></i> Lun-Ven: 9:00-18:00</p>
                </div>
                <button class="btn">Verifica Garanzia</button>
            </div>
    </section>
