...
<html lang="it">
    ...
    <section class="products-section">
        <h2 class="section-title">Guida all'Acquisto</h2>
        <div class="products-grid">
            <div class="product-card">
                <h3><i class="fas fa-shipping-fast"></i> Spedizioni</h3>
                <p>Consegna in 24/48 ore su tutto il territorio nazionale con corriere espresso</p>
            </div>
            
            <div class="product-card">
                <h3><i class="fas fa-lock"></i> Pagamenti Sicuri</h3>
                <p>Transazioni crittografate con i principali circuiti di pagamento</p>
            </div>
            
            <div class="product-card">
                <h3><i class="fas fa-box-open"></i> Reso Facile</h3>
                <p>30 giorni per cambiare idea e restituire il prodotto</p>
            </div>
        </div>
    </section>
