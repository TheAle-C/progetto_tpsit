...
<html lang="it">
    ...
    <section class="products-section">
        <h2 class="section-title">Resi e Rimborsi</h2>
        <div class="product-card">
            <ol class="guide-steps">
                <li>Accedi al tuo account</li>
                <li>Seleziona l'ordine</li>
                <li>Richiedi reso</li>
                <li>Stampa etichetta</li>
            </ol>
            <div class="product-meta">
                <p><i class="fas fa-history"></i> Tempi di elaborazione: 3-5 giorni lavorativi</p>
            </div>
            <button class="btn">Inizia Reso</button>
        </div>
    </section>
